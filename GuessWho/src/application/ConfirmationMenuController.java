...
/**
 * The controller for the confirmation menu that opens when the user tries to
 * guess. Has methods for each of the buttons, as well as the incorrect guess
 * popup window.
 * 
...
public class ConfirmationMenuController extends Controller {
    ...
    /**
     * Checks that the guess is correct. Happens when the "yes" button is
     * pressed in the confirmation menu.
     * 
    ...
    public void confirm(ActionEvent event) throws IOException {
        ...
        if (correctGuess) {
            try {
                ...
                Parent newRoundParent = FXMLLoader
                        .load(getClass().getResource("NewRoundScreen.fxml"));
            ...
            GameplayScreenController controller = GameplayScreenController
                    .getController();

            // ends turn, which mimics pressing the guess button and sets
            // guessing to false
            controller.endTurn();
    ...
    public void incorrectGuessWindow() {
        ...
        // Makes it so you can't click on the window behind until this one is
        // closed.
        ...
        BackgroundFill backgroundFill = new BackgroundFill(
                Color.rgb(134, 190, 255), CornerRadii.EMPTY, Insets.EMPTY);
        ...
        incorrectGuess.showAndWait(); // can't interact with window below until
                                      // this is closed
    }
}
